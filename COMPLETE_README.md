...
chmod +x rembyte-crm-1.0.3.jar

# Запустить в фоновом режиме
nohup java -jar rembyte-crm-1.0.3.jar &
...
# [Service]
# Type=simple
# ExecStart=/usr/bin/java -jar /path/to/rembyte-crm-1.0.3.jar
# Restart=on-failure
```
...
COPY target/rembyte-crm-1.0.3.jar app.jar
ENTRYPOINT ["java","-jar","/app.jar"]
```

```bash
docker build -t rembyte:1.0.3 .
docker run -p 9087:9087 rembyte:1.0.3
```
